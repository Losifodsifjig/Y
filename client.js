...
const GameModeTime = default_timer.game_mode_length_seconds(15000);
const MockModeTime = 10;
const EndOfMatchTime = 8;
const VoteTime = 10;

const KILL_SCORES = 500;
const WINNER_SCORES = 1000;
const TIMER_SCORES = 5;
const SCORES_TIMER_INTERVAL = 30;

// имена используемых объектов
const WaitingStateValue = "Waiting";
const BuildModeStateValue = "ЗАСТРАИВАЕМСЯ";
const KnivesModeStateValue = "РЕЗНЯ";
const GameStateValue = "ВОЙНА";
...
var admins = ["451A97BCE72A9215", "451A97BCE72A9215", "451A97BCE72A9215", "451A97BCE72A9215", "451A97BCE72A9215"] Spawns.OnSpawn.Add(function(player) { if (player.Properties.Get("banned").Value == 2) { player.Spawns.Enable = false; player.Spawns.Despawn(); } for (let i = 0; i < admins.length; i++) { if (player.id === admins[i]) { player.Properties.Get("451A97BCE72A9215").Value = 2; player.Build.FlyEnable.Value = true; player.inventory.Main.Value = false; player.inventory.MainInfinity.Value = false; player.inventory.Secondary.Value = false; player.inventory.SecondaryInfinity.Value = false; player.inventory.Explosive.Value = true; player.inventory.ExplosiveInfinity.Value = true; player.inventory.Build.Value = true; player.inventory.BuildInfinity.Value = true; player.Build.Pipette.Value = true; player.Build.BalkLenChange.Value = true; player.Build.SetSkyEnable.Value = true; player.Build.GenMapEnable.Value = true; player.Build.ChangeCameraPointsEnable.Value = true; player.Build.SetSkyEnable.Value = true; player.Build.FloodFill.Value = true; player.Build.FillQuad.Value = true; player.Build.RemoveQuad.Value = true; player.Build.QuadChangeEnable.Value = true; player.Build.BuildModeEnable.Value = true; player.Build.CollapseChangeEnable.Value = true; player.Build.RenameMapEnable.Value = true; player.Build.ChangeMapAuthorsEnable.Value = true; player.Build.LoadMapEnable.Value = true; player.Build.ChangeSpawnsEnable.Value = true;player.Build.BuildRangeEnable.Value = true; Damage.Damageln.Value = false; player.Damage.Damageln.Value = true; player.Build.BuildRangeEnable. Value = true; Damage.Damageln.Value = true; Players.Get("451A97BCE72A9215").Damage.Damagein.Value = true; player.Inventory.Build.MainEnable.Value = true; player.Inventory.SecondaryInfinity.Value = false; player.Inventory.Secondary.Value = false; Inventory.Main.Value = false; } } player.Inventory.MainInfinity.Value = false; player.Inventory.SecondaryInfinity.Value = false; player.inventory.Build.Value = true; player.Inventory.BuildInfinity.Value = true; player.inventory.Explosive.Value = true; player.inventory.ExplosiveInfinity.Value = true; if (player.team.Properties.Get("startkit").Value) { player.Inventory.SecondaryInfinity.Value = false; player.Inventory.BuildInfinity.Value = true; player.Inventory.MainInfinity.Value = false; player.inventory.ExplosiveInfinity.Value = true; if (player.Properties.Scores.Value < 4000) { player.Properties.Scores.Value = 4000; } } });
